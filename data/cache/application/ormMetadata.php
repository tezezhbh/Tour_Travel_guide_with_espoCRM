  ...
  'CTourPackage' => [
    'attributes' => [
      ...
      'priceConverted' => [
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.price, priceCurrencyRateCTourPackage{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'priceCurrencyRateCTourPackage{alias}Foreign',
              2 => [
                'priceCurrencyRateCTourPackage{alias}Foreign.id:' => '{alias}.priceCurrency'
              ]
            ]
          ]
        ],
